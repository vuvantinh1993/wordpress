...
if( ! defined( 'THE_MINIMAL_THEME_VERSION' ) ) define( 'THE_MINIMAL_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'THE_MINIMAL_THEME_NAME' ) ) define( 'THE_MINIMAL_THEME_NAME', $theme_data->get( 'Name' ) );
...
function the_minimal_scripts() {
    ...
    wp_enqueue_script( 'owl-carousel-accessibility', get_template_directory_uri() . '/js'  . $build .  '/owl.carousel.aria' . $suffix . '.js', array( 'jquery' ), '2.0.0', true );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'the-minimal' ), $name ) ; ?></p>
...
if( ! function_exists( 'the_minimal_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function the_minimal_restore_admin_notice(){
    update_option( 'the_minimal_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'the_minimal_restore_admin_notice' );
